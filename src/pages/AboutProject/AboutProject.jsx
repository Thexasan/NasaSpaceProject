...
const AboutProject = () => {
  ...
  async  function getProject(){
    try {
      ...
      setThisProject(data.data.find((e)=> e.id == id))
    ...
    <div>
                ...
                <div className="w-[85%] flex flex-wrap justify-start content-between">
                  <div className="w-[100%] flex flex-wrap">
                    <p className="w-[100%] font-[500] text-[20px] text-[#000]">
                      Work author:{" "}
                      <span className="font-[400] text-[#474747]">Mark Ali</span>
                    </p>
                    <p className="w-[100%] font-[500] text-[20px] text-[#000]">
                      Subject :{" "}
                      <span className="font-[400] text-[#474747]">{thisProject.scientificDirectionName}</span>{" "}
                    </p>
                    <p className="text-[#474747] text-[20px] mt-[5px] button">While working on a biology research project titled 
                    "Study of the process of adaptation of an ant colony to an artificial habitat", an 11th grade student conducted 
                    observations of ant colonies under the influence of external factors to study the process of adaptation of ants 
                    to an artificial habitat.</p>
                  </div>
                  <Button
        ...
        {thisProject?.projectFileName && (
                      <iframe
                        ...
                        src={`${import.meta.env.VITE_APP_FILES_URL}${thisProject?.projectFileName}`}
                        width="100%"
                        height="400px"
                      ></iframe>
        )}
