...
const Chat = () => {
    ...
    return (
      <div className='ml-[0px] h-[90vh] flex justify-start items-start'>
            {/* sideBar */}
        <div className="w-[100px] h-[90%] my-[20px] mr-[10px] ml-[50px] rounded-[25px] bg-[#3797f0]"></div>    

            {/* users */}
        <div className="w-[29.2%] ml-[] h-[100%] justify-center content-start flex flex-wrap border-r-[1px] border-r-gray-300">
                ...
                <div className="w-[100%]  h-[100vh]">
                    ...
                    <div className="w-[100%] h-[82vh] flex flex-wrap justify-center content-start overflow-y-scroll">
                        ...
                        <div style={{justifyContent:"start"}} className="w-[100%] my-[2px] flex mr-[10px]">
                          ...
                          <p style={{backgroundColor:"#efefef"||"#efefef",color:"black"}} className='max-w-[654px] overflow-hidden min-h-[34px]  text-[15px] py-[5px] px-[10px] rounded-[12px]'>Hi, your work is amazing.</p>
                        </div>
                        ...
                        <div style={{justifyContent:"end"}} className="w-[100%] my-[2px] flex mr-[10px]">
                          ...
                          <p style={{backgroundColor:"#3797f0",color:"white"}} className='max-w-[654px] overflow-hidden min-h-[34px]  text-[15px] py-[5px] px-[10px] rounded-[12px]'>Hi, your work is amazing.</p>
                        </div>
                    </div>
